...
export default function SView({ svg }: Props) {
  return (
    <div 
      ...
      onMouseDown={(e) => {
        ...
        let initialViewBox = svgElement.getAttribute("viewBox").split(" ").map(Number);
        ...
        const onMouseMove = (moveEvent) => {
          ...
          svgElement.setAttribute("viewBox", `${x - dx/2} ${y - dy/2} ${width} ${height}`);
        };
