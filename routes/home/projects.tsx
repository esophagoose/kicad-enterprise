    ...
    return (
        <div class="flex flex-col h-full w-full items-center justify-center text-neutral-600">
            ...
            <p class="text-xl py-4">
                <button class="px-2 py-1 border-neutral-600 border-2 rounded hover:bg-lime-700 hover:border-lime-700 active:bg-lime-800 active:border-lime-800 hover:text-white font-bold text-sm transition-colors">
